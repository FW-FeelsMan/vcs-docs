// wwwroot/js/support/op/open-tickets-columns-resize.js
// Open tickets columns resize (stable, like accounts):
...
(() => {
    if (window.__opTicketsColResizeInit) return;
    window.__opTicketsColResizeInit = true;

    const ROOT_ID = "op-open-tickets";
    const TABLE_ID = "opTicketsTable";

    const STORAGE_KEY = "opTicketsTable.colWidths.v4";
    const MIN_COL_PX = 70;
    ...
    window.initOpTicketsColResize = initOnce;
})();
